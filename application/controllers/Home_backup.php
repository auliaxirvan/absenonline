...
class Home extends Frontend_Controller {
	...
	public function __construct()
	{
		parent::__construct();
		$this->_init();
		$this->load->model(['m_user','m_absen','m_instansi','m_data_lkh','m_sch_lkh']);
