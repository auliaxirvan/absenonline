    ...
    <div id="appCapsule">
        <div class="section mt-2">
            <?php if (!empty($jadwal)) { ?>
                <?php if ($start_jadwal->start_time != "00:00:00" && (!empty($start_jadwal->start_time))) { ?>
                    <?php if (empty($libur)) { ?>
            ...
            <?php if ($wfo == true) { ?>
                <div class="card bg-light mb-2">
                    ...
                    <div class="card-body p-1">
                        ...
                        <button type="button" <?= $btn_disabled ?> class="btn btn-primary mt-1 col-12 btn_absen" id="wfo_btn" <?php if (empty($id_allow)) {
                        ...
                        <?php
                        if (!empty($jadwal_apel) && ($jadwal_apel->name == "Wirid Pengajian Korpri" || $jadwal_apel->name == "Upacara")) {
                            //  var_dump($jadwal_apel);
                            if (hari($jadwal_apel->tgl_apel) === "Jumat") {
                                $jenis_apel = "Wirid";
                            } else if (hari($jadwal_apel->tgl_apel) === "Rabu") {
                                $jenis_apel = "Olahraga";
                            } else {
                                $jenis_apel = "Upacara";
                            }
    ...
    <script type="text/javascript">
        ...
        const citymap = {
            0: {
                center: {
                    lat: -0.31503479847521254,
                    lng: 100.03070583479118
                },
                radius: 50,
                population: 2714856,
            },
